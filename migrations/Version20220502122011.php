 ...
 */
final class Version20220502122011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT NOT NULL, root_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) DEFAULT NULL, is_dir BOOLEAN NOT NULL, lft INT NOT NULL, lvl INT NOT NULL, rgt INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE topic (code VARCHAR(10) NOT NULL, root_id VARCHAR(10) DEFAULT NULL, parent_id VARCHAR(10) DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, lft INT NOT NULL, lvl INT NOT NULL, rgt INT NOT NULL, PRIMARY KEY(code))');
