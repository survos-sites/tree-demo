 ...
 */
final class Version20240630125858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE building (id INT NOT NULL, user_id INT NOT NULL, parent_id INT DEFAULT NULL, root_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, child_count INT NOT NULL, lvl INT NOT NULL, lft INT NOT NULL, rgt INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E16F61D4A76ED395 ON building (user_id)');
        $this->addSql('CREATE INDEX IDX_E16F61D4727ACA70 ON building (parent_id)');
        $this->addSql('CREATE INDEX IDX_E16F61D479066886 ON building (root_id)');
        ...
        $this->addSql('CREATE TABLE location (id INT NOT NULL, root_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, building_id INT NOT NULL, code VARCHAR(32) NOT NULL, order_idx INT DEFAULT NULL, name VARCHAR(80) NOT NULL, child_count INT NOT NULL, lvl INT NOT NULL, lft INT NOT NULL, rgt INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE building ADD CONSTRAINT FK_E16F61D4727ACA70 FOREIGN KEY (parent_id) REFERENCES building (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE building ADD CONSTRAINT FK_E16F61D479066886 FOREIGN KEY (root_id) REFERENCES building (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building DROP CONSTRAINT FK_E16F61D4727ACA70');
        $this->addSql('ALTER TABLE building DROP CONSTRAINT FK_E16F61D479066886');
